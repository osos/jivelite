...
local log                    = require("jive.utils.log").logger("applet.JogglerGridSkin")
...
local imgpath = "applets/JogglerGridSkin/images/"
...
function param(self)
		...
		radialClock = {
			hourTickPath     = imgpath .. 'Clocks/Radial/radial_ticks_hr_on.png',
			minuteTickPath   = imgpath .. 'Clocks/Radial/radial_ticks_min_on.png',
		},
